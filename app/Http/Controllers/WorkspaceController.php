...
class WorkspaceController extends Controller
{
    ...
    public function updateSetup(Request $request, InterviewWorkspaceService $workspace): JsonResponse
    {
        $validated = $request->validate([
            ...
            'targetField' => ['nullable', 'string', 'max:120'],
            'panelMode' => ['nullable', 'string', 'in:single,panel,hr,technical,scholarship,admission'],
            'difficultMode' => ['nullable', 'boolean'],
            'fillerTracking' => ['nullable', 'boolean'],
            'adviserReviewMode' => ['nullable', 'boolean'],
            'weeklyGoal' => ['nullable', 'integer', 'min:1', 'max:7'],
            'reminderDays' => ['nullable', 'array', 'max:7'],
            'reminderDays.*' => ['string', 'in:Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday'],
        ]);
    ...
    ): JsonResponse
    {
        $validated = $request->validate([
            ...
            'answers.*.feedbackSummary.answerVersions' => ['nullable', 'array', 'max:8'],
            'answers.*.feedbackSummary.answerVersions.*.label' => ['nullable', 'string', 'max:80'],
            'answers.*.feedbackSummary.answerVersions.*.answer' => ['nullable', 'string', 'max:20000'],
            'answers.*.feedbackSummary.answerVersions.*.savedAt' => ['nullable', 'date'],
            'answers.*.feedbackSummary.answerVersions.*.source' => ['nullable', 'string', 'max:120'],
            'answers.*.feedbackSummary.answerVersions.*.question' => ['nullable', 'string', 'max:4000'],
            'answers.*.feedbackSummary.speakingHabits' => ['nullable', 'array'],
            'answers.*.feedbackSummary.speakingHabits.fillerCounts' => ['nullable', 'array'],
            'answers.*.feedbackSummary.speakingHabits.totalFillers' => ['nullable', 'integer', 'min:0', 'max:999'],
            'answers.*.feedbackSummary.speakingHabits.totalWords' => ['nullable', 'integer', 'min:0', 'max:5000'],
            'answers.*.feedbackSummary.speakingHabits.fillerRate' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'answers.*.feedbackSummary.speakingHabits.repeatedPhraseCount' => ['nullable', 'integer', 'min:0', 'max:999'],
            'answers.*.feedbackSummary.speakingHabits.longPauseCount' => ['nullable', 'integer', 'min:0', 'max:999'],
            'answers.*.feedbackSummary.speakingHabits.pacePerMinute' => ['nullable', 'integer', 'min:0', 'max:500'],
            'answers.*.feedbackSummary.speakingHabits.summary' => ['nullable', 'string', 'max:500'],
            'answers.*.feedbackSummary.panel' => ['nullable', 'array'],
            'answers.*.feedbackSummary.panel.mode' => ['nullable', 'string', 'max:50'],
            'answers.*.feedbackSummary.panel.role' => ['nullable', 'string', 'max:120'],
            'answers.*.feedbackSummary.documentAnalysis' => ['nullable', 'array'],
            'answers.*.feedbackSummary.documentAnalysis.categoryName' => ['nullable', 'string', 'max:120'],
            'answers.*.feedbackSummary.documentAnalysis.analyzedAt' => ['nullable', 'date'],
            'answers.*.feedbackSummary.documentAnalysis.signalCount' => ['nullable', 'integer', 'min:0', 'max:999'],
            'answers.*.feedbackSummary.adviserReview' => ['nullable', 'array'],
            'answers.*.feedbackSummary.adviserReview.reviewer' => ['nullable', 'string', 'max:120'],
            'answers.*.feedbackSummary.adviserReview.sessionComment' => ['nullable', 'string', 'max:2000'],
            'answers.*.feedbackSummary.adviserReview.updatedAt' => ['nullable', 'date'],
            'answers.*.feedbackSummary.adviserReview.status' => ['nullable', 'string', 'max:80'],
