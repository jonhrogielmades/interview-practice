                ...
                <div
                    ...
                    <div class="max-w-2xl">
                        ...
                        <h3 id="practiceModalCategoryName" class="mt-2 text-xl font-semibold text-gray-900 dark:text-white/90">
                            Choose a track for live practice
                        </h3>
                        <p id="practiceModalSummaryText" class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-400">
                            Choose a track from the sidebar. The interviewer will open the workspace, ask aloud, and continue after each submitted answer.
                        </p>
                    </div>
        ...
        <div
            ...
            <div class="max-w-2xl">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Pick the interview category, confirm your target field, and the live interview workspace will take over.
                </p>
            </div>
    ...
    <div
        ...
        <div
            ...
            <div class="max-w-2xl">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Use the chatbot to turn your chosen category into a specific role, course, or focus before the live interview begins.
                </p>
            </div>
                ...
                <section class="space-y-5 xl:col-span-5">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    Set the interview length, coaching focus, and pacing before the field is generated.
                                </p>
                            </div>
                        </div>
                    ...
                    <article class="rounded-2xl border border-gray-200/50 bg-white/80 p-5 shadow-theme-xs backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-theme-md dark:border-white/5 dark:bg-gray-900/80">
                        <div class="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    Pick a field suggestion, then refine it with the chatbot.
                                </p>
                            </div>
                        </div>
                    ...
                    <article class="rounded-2xl border border-gray-200/50 bg-white/80 p-5 shadow-theme-xs backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-theme-md dark:border-white/5 dark:bg-gray-900/80">
                        ...
                        <p
                            ...
                            class="content-break mt-2 text-sm leading-6 text-gray-600 dark:text-gray-400">
                            Tell the chatbot what role, course, or specialization you want so the interviewer can tailor the live questions.
                        </p>
                    </article>
                </section>
                ...
                <section class="xl:col-span-7">
                    <article class="rounded-2xl border border-gray-200/50 bg-white/80 p-4 shadow-theme-xs backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-theme-md sm:p-5 dark:border-white/5 dark:bg-gray-900/80">
                        ...
                        <div
                            ...
                            class="mt-4 flex min-h-[160px] max-h-[240px] flex-col gap-3 overflow-y-auto rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/70 sm:min-h-[180px] sm:max-h-[280px]"></div>
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    class="min-h-[110px] w-full rounded-2xl border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
    ...
    <div
        ...
        <div
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Answer naturally while the interviewer asks aloud and moves through the conversation automatically.
                </p>
            </div>
                ...
                <section class="min-w-0 xl:col-span-7">
                    <article class="rounded-2xl border border-gray-200/50 bg-white/80 p-4 shadow-theme-xs backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-theme-md sm:p-5 dark:border-white/5 dark:bg-gray-900/80">
                        ...
                        <div class="mt-6 space-y-5">
                            <div
                                id="openingIntroductionSection"
                                class="hidden rounded-2xl border border-brand-100 bg-brand-50/70 p-4 dark:border-brand-500/20 dark:bg-brand-500/10">
                                <p class="text-xs font-medium uppercase tracking-wide text-brand-700 dark:text-brand-300">
                                    Opening Conversation
                                </p>
                                <p
                                    id="openingIntroductionText"
                                    class="content-break mt-3 text-sm leading-6 text-gray-700 dark:text-gray-300">
                                    The interviewer greeting will appear here before Question 1 begins.
                                </p>
                            </div>

                            <div>
                                <p class="mb-2 text-xs font-medium uppercase tracking-wide text-gray-500">Interviewer asks</p>
                                <h2
                                    ...
                                    Choose a track from the sidebar to enter your interview simulation.
                                </h2>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    id="responseInput"
                                    class="dark:bg-dark-900 min-h-[140px] w-full rounded-2xl border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 sm:min-h-[180px]"
                                    placeholder="Turn on the mic and answer naturally. Your words will appear here while the interviewer listens."></textarea>

                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    With Mic On, pause for a moment when you are done. Say "repeat the question" if you need to hear it again.
                                </p>
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <button
                                    id="endSessionBtn"
                                    type="button"
                                    class="inline-flex w-full items-center justify-center rounded-lg border border-error-300 px-4 py-3 text-sm font-medium text-error-600 transition hover:bg-error-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-error-500/40 dark:text-error-300 dark:hover:bg-error-500/10 min-h-[44px] sm:w-auto">
                                    End Interview
                                </button>
                            </div>
                            ...
                            <div
                                ...
                                <span id="voiceStatusText" class="content-break">Mic is idle.</span>
                            </div>

                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                Real-time speech-to-text works best in Chrome or Edge while running on localhost or HTTPS.
                            </p>
                    ...
                    <article
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    The AI voice reads each question aloud while a live waveform mirrors the spoken
                                    cadence, and the camera helps surface selected
                        ...
                        <div class="mt-5 space-y-4">
                            <div
                                ...
                                <div class="flex min-w-0 flex-col gap-4">
                                    <div
                                        id="avatarOrb"
                                        class="voice-wave-shell w-full"
                                        data-speaking="false"
                                        aria-hidden="true">
                                        <div class="voice-wave-bars" id="voiceWaveBars">
                                            @for ($bar = 0; $bar < 17; $bar++)
                                                <span class="voice-wave-bar" data-wave-bar style="--bar-index: {{ $bar }};"></span>
                                            @endfor
                                        </div>
                                        <div class="voice-wave-meta">
                                            <span class="voice-wave-meta-dot"></span>
                                            <span>Realtime speech wave</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="min-w-0 text-center">
                                        ...
                                        <p
                                            id="avatarWordText"
                                            class="mt-1 text-xs font-medium uppercase tracking-[0.2em] text-brand-600 dark:text-brand-300">
                                            Waiting for spoken question
                                        </p>
                                        <p id="avatarLineText" class="content-break mt-2 text-sm leading-6 text-gray-600 dark:text-gray-400">
                                            Turn on the camera, then choose a category. The waveform will react as I read
                                            each interview question aloud.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 flex flex-wrap gap-3">
                                    <button
                                        id="startCameraBtn"
                                        type="button"
                                        class="inline-flex w-full items-center justify-center rounded-lg border border-gray-300 px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-white/[0.03] min-h-[44px] sm:w-auto">
                                        Camera On
                                    </button>
                            ...
                            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-black dark:border-gray-800">
                                <video id="faceCameraVideo" autoplay muted playsinline class="h-64 w-full object-cover sm:h-56"></video>
                            </div>
                            ...
                            <div class="grid gap-3 sm:grid-cols-2">
                                ...
                                <div
                                    class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-800 dark:bg-gray-900/70">
                                    <p class="text-xs uppercase tracking-wide text-gray-500">Voice Wave</p>
                                    <strong
                                        id="avatarVoiceValue"
                                        class="mt-2 block text-sm font-semibold text-gray-900 dark:text-white/90">
                                        Ready
                                ...
                                <div
                                    class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-800 dark:bg-gray-900/70 sm:col-span-2">
                            ...
                            <div
                                class="hidden rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/70"
                                aria-hidden="true">
                                ...
                                <p id="livePresenceTip" class="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-400">
                                    Turn on the camera to unlock selected non-verbal coaching for eye contact, posture,
                                    head movement, and facial composure.
                                </p>
                            </div>

                            <div class="hidden grid gap-4 xl:grid-cols-2" aria-hidden="true">
                    ...
                    <article
                        ...
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    Open the question generator in a modal whenever you want to build or refresh the set.
                                </p>
                            </div>

                            <button
                                id="openPracticeQuestionAgentModalBtn"
                                type="button"
...
<div
    ...
    class="fixed z-[10005] hidden items-start justify-center"
    :style="wrapperStyle"
    aria-hidden="true"
    aria-labelledby="practiceQuestionAgentModalTitle"
    aria-modal="true"
    role="dialog">
    ...
    <div
        ...
        <div
            ...
            <div class="max-w-2xl">
                ...
                <h2 id="practiceQuestionAgentModalTitle" class="mt-1 text-lg font-semibold text-gray-900 dark:text-white/90">
                    Build or refresh the question set
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Generate fresh category-based questions and keep the active prompt synced with the interviewer voice.
                </p>
            </div>

            <button
                id="closePracticeQuestionAgentModalBtn"
                type="button"
                class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 text-gray-500 transition hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white sm:h-11 sm:w-11">
                <span class="sr-only">Close question chatbot modal</span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
        ...
        <div class="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
            <article class="flex h-full flex-col rounded-2xl border border-gray-200/50 bg-white/80 p-4 shadow-theme-xs backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-theme-md sm:p-5 dark:border-white/5 dark:bg-gray-900/80">
                ...
                <div class="mt-4 rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/70">
                ...
                <div class="mt-4 rounded-2xl border border-dashed border-gray-300 px-4 py-4 dark:border-gray-700">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="mt-3 min-h-[100px] w-full rounded-2xl border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
