            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">Jonh Rogiel Tumanda</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">Add your phone number</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Bio</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">Focused on interview practice, programming, and continuous improvement.</p>
                    </div>
                </div>
            </div>
