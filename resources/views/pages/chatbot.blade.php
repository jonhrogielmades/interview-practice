...
@section('content')
    ...
    <section class="mb-6 overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="chatbot-provider-grid grid auto-rows-fr items-stretch gap-4 p-4 sm:p-6">
            @foreach ($chatbotProviders as $provider)
                ...
                <article
                    ...
                    <p class="mt-3 flex-1 text-sm leading-6 text-gray-600 dark:text-gray-400">{{ $provider['description'] }}</p>
                    <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
                        Model: {{ $provider['model'] ?: 'Dynamic' }}
                    </p>
                    <p data-provider-note class="text-xs leading-5 text-gray-500 dark:text-gray-400">
