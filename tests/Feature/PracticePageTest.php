...
test('practice page uses sidebar launch guidance and keeps live visual coaching', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertSee('data-app-shell-main', false)
        ->assertSee('data-app-content', false)
        ->assertSee('class="practice-session-focus-shell', false)
        ->assertSee('class="practice-session-panel', false)
